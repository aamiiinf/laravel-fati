...
//        ]);
        ...
        $name_gen = hexdec(uniqid()).'.'.$imag_one->getClientOriginalName();
//            $name_gen = hexdec(uniqid()).'.'.$imag_one->getClientOriginalExtension();
        Image::make($imag_one)->resize(270,270)->save('images/upload/'.$name_gen);
        $img_url1 = 'images/upload/'.$name_gen;

        $imag_two = $request->file('image_two');
        $name_gen = hexdec(uniqid()).'.'.$imag_two->getClientOriginalName();
//            $name_gen = hexdec(uniqid()).'.'.$imag_two->getClientOriginalExtension();
        Image::make($imag_two)->resize(270,270)->save('images/upload/'.$name_gen);
        $img_url2 = 'images/upload/'.$name_gen;

        $imag_three = $request->file('image_three');
        $name_gen = hexdec(uniqid()).'.'.$imag_three->getClientOriginalName();
//            $name_gen = hexdec(uniqid()).'.'.$imag_three->getClientOriginalExtension();
        Image::make($imag_three)->resize(270,270)->save('images/upload/'.$name_gen);
        $img_url3 = 'images/upload/'.$name_gen;
