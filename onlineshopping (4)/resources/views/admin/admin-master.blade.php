...
@endforeach
<!-- ########## START: LEFT PANEL ########## -->
<div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> پنل ادمین</a></div>
    ...
    <div class="sl-sideleft-menu">
        <a href="{{ url('admin/home') }}" class="sl-menu-link @yield('dashboard') ">
            <div class="sl-menu-item">
                ...
                <span class="menu-item-label">داشبورد</span>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <a href="{{ url('/') }}" target="_blank" class="sl-menu-link">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                <span class="menu-item-label">مشاهده سایت</span>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <a href="{{ route('admin.category') }}"  class="sl-menu-link @yield('category')">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                <span class="menu-item-label">دسته بندی ها</span>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <a href="{{ route('admin.brand') }}"  class="sl-menu-link @yield('brand')">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                <span class="menu-item-label">برند ها</span>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
...
{{--            <li class="nav-item"><a href="{{ route('add-products') }}" class="nav-link">  @yield('add-products')  Add Products </a></li>--}}
            <li class="nav-item"><a href="{{ route('add-products') }}" class="nav-link @yield('add-products')">افزودن محصول</a></li>
{{--            <li class="nav-item"><a href="{{ route('manage-products') }}" class="nav-link  @yield('manage-products')">Manage Product</a></li>--}}
            <li class="nav-item"><a href="{{ route('manage-products') }}" class="nav-link @yield('manage-products')">مدیریت محصولات</a></li>
        ...
        <a href="{{ route('admin.coupon') }}"  class="sl-menu-link @yield('coupon')">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                <span class="menu-item-label">کد تخفیف ها</span>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->

        <a href="{{ route('admin.orders') }}"  class="sl-menu-link @yield('order')">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                <span class="menu-item-label">سفارشات</span>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
...
{{--                    <span class="logged-name">{{ \Illuminate\Support\Facades\Auth::user()->name }}<span class="hidden-md-down"> </span></span>--}}
...
{{--                        <li><a href=""><i class="icon ion-ios-folder-outline"></i> Collections</a></li>--}}
                        <li><a href="{{ route('logout') }}"
                               onclick="event.preventDefault();
                                            document.getElementById('logout-form').submit();">       <i class="icon ion-power"></i> Sign Out</a><form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                @csrf
                            </form></li>
    ...
    <div class="tab-content">
        <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
            <div class="media-list">
                ...
                <a href="" class="media-list-link">
                    <div class="media">
                        <img src="{{assert('admin/img/img4.jpg')}}" class="wd-40 rounded-circle" alt="">
                        <div class="media-body">
